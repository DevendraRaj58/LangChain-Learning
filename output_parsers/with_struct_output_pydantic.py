...
class Review(BaseModel):
    key_themes : list[str] = Field(description="Write down multiple themes discussed in the review")
    summary: str = Field (description="A brief summary of the review")
    sentiment : Literal["pos","neg"]= Field(description="Brief summary of review")
    pros: Optional[list[str]] =Field(default=None,description="Write Pros mentioned in the review inside the list")
    cons: Optional[list[str]] = Field(default=None,description="Write Cons mentioned in the review inside the list")
...
looks outdated compared to other brands. Hoping for a software update to fix thisl.
