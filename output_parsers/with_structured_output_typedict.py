...
class Review(TypedDict):
    key_themes : Annotated[list[str],"Write down multiple themes discussed in the review"]
    pros: Annotated[Optional[list[str]],"Write Pros mentioned in the review inside the list"]
    cons: Annotated[Optional[list[str]],"Write Cons mentioned in the review inside the list"]
    summary:Annotated[str,"Brief summary of review"]
    sentiment:Annotated[str,"Return review sentiment."]
